...
def run_experiment(
    ...
    # Training setup (NO CLASS WEIGHTS - let natural learning with more updates from batch_size=16)
    print("\n⚙️  Training setup:")
    print("   Strategy: NO class weights + smaller batch size (16)")
    print("   Reasoning: More updates per epoch helps minority classes learn naturally")
